...
class Graby
{
    ...
    public function __construct(
        ...
        // Debug mode can be activated by passing `debug: true` to `GrabyConfig`
        // More details on the retrieved code and its consequent modifications can be obtained by passing `logLevel: LogLevel::Debug` to `GrabyConfig`
