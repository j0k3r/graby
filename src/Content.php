...
final class Content
{
     ...
     */
    public function __construct(private EffectiveResponse $effectiveResponse, private string $html, private string $title, private ?string $language, private ?string $date, private array $authors, private ?string $image, private bool $isNativeAd, private ?string $summary = null)
    {
    }
